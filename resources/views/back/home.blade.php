...
@section('content')
<script src={{URL::asset('js/back/ajax_call.js')}}></script>
<script src={{URL::asset('js/back/image_preview.js')}}></script>
                        ...
                        <div class="image text-center">
                            <label for="file-input">
                                <div class="upload-icon">
                                    ...
                                    <img style="cursor: pointer;" src={{asset('images/perfil/usuarios/'.Auth::user()->foto)}} alt="Foto de perfil" data-toggle="tooltip" data-placement="right" title="Haz clic para cambiar la foto de perfil" class="rounded img-fluid foto-perfil">
                                 </div>
                               </label>
