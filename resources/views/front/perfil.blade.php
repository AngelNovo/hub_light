                    ...
                    <div class="avatar">
                        <label>
                            <div class="upload-icon">
                                <img src={{asset('images/perfil/usuarios/'.Auth::user()->foto)}} alt="Foto de perfil" data-toggle="tooltip" data-placement="right" title="Haz clic para cambiar la foto de perfil" class="foto-perfil">
                                </div>
                            </label>
                    </div>
                    @if ($user->actiu==1)
